...
import com.nyaka.bank.config.JwtUtils;
import com.nyaka.bank.dto.*;
import com.nyaka.bank.entity.Account;
import com.nyaka.bank.entity.Role;
import com.nyaka.bank.entity.User;
import com.nyaka.bank.repository.RoleRepository;
...
public class UserServiceImpl implements UserService {
    ...
    public List<UserDto> findAll() {
        return repository.findAll()
                .stream()
                .map(UserDto::fromEntity)  //Method reference equivaut à .map(u -> UserDto.fromEntity(u))
